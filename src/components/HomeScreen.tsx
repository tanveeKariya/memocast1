                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="relative">
                        ...
                        {showFolderMenu === folder._id && (
                          ...
                          <div className="absolute right-0 top-12 bg-white rounded-xl shadow-xl border border-gray-200 py-2 z-[9999] min-w-[150px] max-w-[200px]">
                            <button
                              onClick={(e) => {
                                e.stopPropagation();
                            ...
                            <div className="relative group">
                              ...
                              <div className="absolute left-full top-0 ml-2 hidden group-hover:block bg-white border border-gray-200 rounded-lg shadow-xl p-2 min-w-[140px] z-[9999]">
                                <button
                                  onClick={(e) => {
                                    e.stopPropagation();
